...
import io.github.colintimbarndt.chat_emotes.common.data.unicode.UnicodeModifierType.Companion.build
...
object UnicodeEmoteDataSerializer : EmoteDataSerializer<UnicodeEmoteData> {
    ...
    private inline fun applyModifiers(
        ...
        for (sample in samples) {
            ...
            // Add modified emote
            val baseEmote: io.github.colintimbarndt.chat_emotes.common.data.Emote? = run {
    ...
    private fun createEmote(
    ...
    ): io.github.colintimbarndt.chat_emotes.common.data.Emote {
        ...
        return io.github.colintimbarndt.chat_emotes.common.data.Emote(font, ch, aliases, emoticons, seq)
    }
