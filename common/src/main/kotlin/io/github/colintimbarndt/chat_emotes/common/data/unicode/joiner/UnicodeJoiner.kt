...
import io.github.colintimbarndt.chat_emotes.common.data.unicode.joiner.JoinerSlot.Companion.parse
import io.github.colintimbarndt.chat_emotes.common.data.unicode.pattern.PatternSlot
...
class UnicodeJoiner private constructor() {
    ...
    fun evaluate(captures: CapturedResults): String {
