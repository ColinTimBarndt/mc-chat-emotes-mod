...
abstract class BasicComponentBuilder internal constructor(
    ...
    override fun color(color: ChatColor): BasicComponentBuilder {
        ensureNotBuilt()
    ...
    override fun bold(bold: Boolean): BasicComponentBuilder {
        ensureNotBuilt()
        delegate.style = delegate.style.withBold(bold)
        return this
    }

    override fun italic(italic: Boolean): BasicComponentBuilder {
        ensureNotBuilt()
        delegate.style = delegate.style.withItalic(italic)
        return this
    }

    override fun underlined(underline: Boolean): BasicComponentBuilder {
        ensureNotBuilt()
        delegate.style = delegate.style.withUnderlined(underline)
        return this
    }

    override fun insertion(insertion: String): BasicComponentBuilder {
        ensureNotBuilt()
        delegate.style = delegate.style.withInsertion(insertion)
        return this
    }

    override fun font(font: ResourceLocation): BasicComponentBuilder {
        ensureNotBuilt()
...
class ComponentBuilder internal constructor(
    ...
    override fun copied(): ComponentBuilder {
    ...
    private inner class SiblingImmutableComponentBuilder(
        ...
        override fun append(next: Component): SiblingImmutableComponentBuilder {
            ensureNotBuilt()
        ...
        override fun copied(): SiblingComponentBuilder {
    ...
    private inner class SiblingComponentBuilder(component: MutableComponent) : BasicComponentBuilder(component) {
        ...
        override fun copied() = ComponentBuilder(delegate.copy())
    }
}