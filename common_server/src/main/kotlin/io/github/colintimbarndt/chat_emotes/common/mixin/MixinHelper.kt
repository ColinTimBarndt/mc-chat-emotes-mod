 ...
 */
fun attemptLoadModLanguage(modClass: Class<*>, path: String, keyAdder: BiConsumer<String, String>) =
    try {
        ...
        logParseLanguageError(path, ex)
    } catch (ex: IOException) {
        logParseLanguageError(path, ex)
    }

private fun logParseLanguageError(path: String, error: Throwable) =
    LOGGER.error("Couldn't parse strings from {}", path, error)
